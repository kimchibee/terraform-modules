...
> **📌 AVM 적용 범위·작업 계획**: 이 레포 기준 **모듈별 AVM-only / AVM+azurerm / azurerm 예외** 분류는 **[docs/AVM_COVERAGE.md](./docs/AVM_COVERAGE.md)** , 목표·판단 요약은 **[docs/WORK_PLAN_AVM_STRATEGY.md](./docs/WORK_PLAN_AVM_STRATEGY.md)** 를 본다.
